...
//                int lecture_time_2_end = Integer.parseInt(lecture_time_1_end);
                ...
                Toast.makeText(stat_class_information_Activity.this, "课时信息："+s1, Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(stat_class_information_Activity.this, "该时段已有课程，请先删除该时段课程后再增加课程信息", Toast.LENGTH_SHORT).show();
//                        }
//
//                    } while (cursor.moveToNext());
//                }
//                Toast.makeText(stat_class_information_Activity.this, "若仅出现此弹窗说明无课程冲突，可插入课程信息，若有两次弹窗出现则需要删除该时段课程再进行插入课程信息", Toast.LENGTH_SHORT).show();
